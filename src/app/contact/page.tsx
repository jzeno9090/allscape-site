...
export const metadata: Metadata = {
  ...
  description: `Submit a request to Allscape Services for lawn irrigation, landscape lighting, holiday lighting, paver restoration, drainage, or raised gardens. Call ${business.phone} or fill out the form.`,
};
