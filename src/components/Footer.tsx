        ...
        <div className="grid md:grid-cols-12 gap-10 mb-12">
          <div className="md:col-span-4">
            ...
            <p className="text-sm leading-relaxed">
              ...
              irrigation, landscape lighting, holiday lighting, paver restoration, drainage, and raised gardens.
            </p>
            {(business.social.facebook || business.social.instagram) && (
              <div className="mt-6">
                <div className="text-xs uppercase tracking-widest text-green-soft font-bold mb-3">Follow us</div>
                <div className="flex gap-3">
                  {business.social.facebook && (
                    <a
                      ...
                      aria-label="Allscape Services on Facebook"
                      className="w-10 h-10 rounded-full bg-white/10 hover:bg-green flex items-center justify-center transition-colors"
                    >
                  ...
                  {business.social.instagram && (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      aria-label="Allscape Services on Instagram"
                      className="w-10 h-10 rounded-full bg-white/10 hover:bg-green flex items-center justify-center transition-colors"
                    >
                      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
